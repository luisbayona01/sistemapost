...
<div class="w-full px-4 md:px-6 py-4">
    <h1 class="text-3xl font-bold text-center text-gray-900 mb-6">Presentaciones</h1>

    <x-breadcrumb.template>
        <x-breadcrumb.item :href="route('admin.dashboard.index')" content="Inicio" />
        <x-breadcrumb.item active='true' content="Presentaciones" />
    </x-breadcrumb.template>
            ...
            <table id="datatablesSimple" class="w-full border-collapse">
                <thead class="bg-gray-100 border-b border-gray-300">
                    <tr>
                        ...
                        <th class="text-left text-gray-900 font-semibold p-3 border border-gray-300">Sigla</th>
                            ...
                            <div class="flex justify-around items-center">
                                <div class="relative group">
                                    ...
                                    <div class="hidden group-hover:block absolute right-0 z-10 bg-white border border-gray-300 rounded-lg shadow-lg min-w-max">
                                        ...
                                        <a class="block px-4 py-2 hover:bg-gray-100 text-gray-900 text-sm" href="{{route('presentaciones.edit',['presentacione'=>$item])}}">Editar</a>
                                        @endcan
                                    </div>
                                </div>
