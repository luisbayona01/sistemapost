            ...
            <form method="POST" action="{{ route('register.store') }}" class="space-y-6">
                ...
                <div class="border-t pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            <label for="empresa_nombre" class="block text-sm font-medium text-gray-700 mb-2">Nombre de la
                                Empresa *</label>
                            <input type="text" id="empresa_nombre" name="empresa_nombre" value="{{ old('empresa_nombre') }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="nit" name="nit" value="{{ old('nit') }}" placeholder="900123456"
                        ...
                        <!-- Email Empresa -->
                        <div>
                            <label for="empresa_email" class="block text-sm font-medium text-gray-700 mb-2">Email de la
                                Empresa</label>
                            <input type="email" id="empresa_email" name="empresa_email" value="{{ old('empresa_email') }}"
                ...
                <div class="border-t pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Nombre Contacto -->
                        <div class="md:col-span-2">
                            <label for="nombre_contacto" class="block text-sm font-medium text-gray-700 mb-2">Nombre
                                Completo *</label>
                            <input type="text" id="nombre_contacto" name="nombre_contacto"
                                value="{{ old('nombre_contacto') }}" placeholder="Juan Pérez García"
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-xs mt-1">Mínimo 8 caracteres, incluye mayúsculas, minúsculas y
                                números</p>
                            @error('password')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                ...
                <div class="text-center">
                    <p class="text-gray-600">
                        ...
                        <a href="{{ route('login.index') }}" class="text-blue-600 hover:underline font-semibold">Inicia
                            sesión aquí</a>
                    </p>
                </div>
            </form>
