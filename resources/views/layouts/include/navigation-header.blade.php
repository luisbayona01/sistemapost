...
<nav class="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
    <div class="flex items-center justify-between h-16 px-6 max-w-full">
        ...
        <div class="flex items-center gap-4">
            <!-- Sidebar Toggle -->
            <button
                class="inline-flex items-center justify-center w-10 h-10 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors duration-200 md:hidden"
                id="sidebarToggle"
            ...
            <!-- Brand -->
            <a
                class="text-lg font-semibold text-gray-900 hover:text-blue-600 transition-colors hidden md:inline-block"
                href="{{ route('panel') }}"
                title="Ir al panel">
                {{ $empresa->nombre ?? 'Panel' }}
            </a>
        </div>
        ...
        <div class="flex items-center gap-2">
            ...
            <div class="relative group">
                ...
                <div class="absolute right-0 w-96 mt-2 bg-white rounded-xl shadow-lg border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-40">
                    <!-- Header -->
                    ...
                    <div class="max-h-80 overflow-y-auto">
                        ...
                        <a
                            ...
                            <p class="text-sm font-medium text-gray-900">{{ $notification->data['message'] ?? 'Nueva notificación' }}</p>
                            <time class="text-xs text-gray-500 mt-1 block">{{ $notification->created_at->diffForHumans() }}</time>
                        </a>
                        @empty
                    ...
                    <div class="px-6 py-3 border-t border-gray-100 bg-gray-50 rounded-b-xl">
                        <a href="#" class="text-center text-sm font-medium text-blue-600 hover:text-blue-700 transition-colors block">
            ...
            <div class="relative group">
                ...
                <!-- User Dropdown Menu -->
                <div class="absolute right-0 w-56 mt-2 bg-white rounded-xl shadow-lg border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-40">
                    <!-- User Info -->
                    ...
                    <div class="py-2">
                        ...
                        <a
                            href="{{ route('logout') }}"
                            class="flex items-center gap-3 px-6 py-2 text-sm text-red-600 hover:bg-red-50 transition-colors duration-200">
