...
@section('content')
    <div class="w-full px-4 md:px-6 py-4">
        ...
        <x-breadcrumb.template>
            ...
            <x-breadcrumb.item :href="route('movimientos.index', ['caja_id' => $caja_id])" content="Movimientos de caja" />
        ...
        <x-forms.template :action="route('movimientos.store')" method='post'>
            ...
            <div class="space-y-6">
                ...
                <div>
                    <x-forms.input id="descripcion" required='true' labelText="Descripcion del retiro" />
                </div>
            ...
            <x-slot name='footer'>
                <button type="submit"
                    class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-8 rounded-lg transition-colors">Guardar</button>
            </x-slot>
