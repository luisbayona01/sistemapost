...
<div class="w-full px-4 md:px-6 py-4">
    <h1 class="text-3xl font-bold text-center text-gray-900 mb-6">Categorías</h1>
            ...
            <table id="datatablesSimple" class="w-full border-collapse">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="text-gray-900 p-3 border border-gray-300">
                            <span class="inline-block px-3 py-1 rounded-full text-sm font-semibold {{ $categoria->caracteristica->estado ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                {{ $categoria->caracteristica->estado ? 'Activo' : 'Eliminado'}}</span>
                        </td>
                        <td class="text-gray-900 p-3 border border-gray-300">
                            <div class="flex justify-around items-center">
                                ...
                                <div class="relative group">
                                    ...
                                    <div class="hidden group-hover:block absolute right-0 z-10 bg-white border border-gray-300 rounded-lg shadow-lg min-w-max">
                                        ...
                                        <a class="block px-4 py-2 hover:bg-gray-100 text-gray-900 text-sm" href="{{route('categorias.edit',['categoria'=>$categoria])}}">Editar</a>
                                        @endcan
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <button title="Eliminar" onclick="document.getElementById('confirmModal-{{$categoria->id}}').classList.remove('hidden')" class="text-gray-600 hover:text-red-600 p-2">
                                        <i class="fas fa-trash-can"></i>
                                    </button>
                                    @else
                                    <button title="Restaurar" onclick="document.getElementById('confirmModal-{{$categoria->id}}').classList.remove('hidden')" class="text-gray-600 hover:text-green-600 p-2">
                    ...
                    <!-- Modal -->
                    <div id="confirmModal-{{$categoria->id}}" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                        <div class="bg-white rounded-lg shadow-lg max-w-md w-full mx-4">
                            ...
                            <div class="bg-gray-100 border-t border-gray-300 px-6 py-4 flex justify-end gap-2">
                                <button type="button" class="bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-lg transition-colors"
                                    onclick="document.getElementById('confirmModal-{{$categoria->id}}').classList.add('hidden')">Cerrar</button>
