...
<div class="w-full px-4 md:px-6 py-4">
    <h1 class="text-3xl font-bold text-center text-gray-900 mb-6">Productos</h1>
            ...
            <table id="datatablesSimple" class="w-full border-collapse">
                <thead class="bg-gray-100 border-b border-gray-300">
                    <tr>
                        ...
                        <th class="text-left text-gray-900 font-semibold p-3 border border-gray-300">Precio</th>
                        <th class="text-left text-gray-900 font-semibold p-3 border border-gray-300">Marca</th>
                        <th class="text-left text-gray-900 font-semibold p-3 border border-gray-300">Categoría</th>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="text-gray-900 p-3 border border-gray-300">
                            <span class="inline-block px-3 py-1 rounded-full text-sm font-semibold {{ $item->estado ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                            ...
                            <div class="flex justify-around items-center">
                                <div class="relative group">
                                    ...
                                    <div class="hidden group-hover:block absolute right-0 z-10 bg-white border border-gray-300 rounded-lg shadow-lg min-w-max">
                                        <!-----Editar Producto--->
                                        @can('editar-producto')
                                        <a class="block px-4 py-2 hover:bg-gray-100 text-gray-900 text-sm" href="{{route('productos.edit',['producto' => $item])}}">
                                            Editar
                                        </a>
                                        @endcan
                                        <!----Ver-producto--->
                                        @can('ver-producto')
                                        <button class="block w-full text-left px-4 py-2 hover:bg-gray-100 text-gray-900 text-sm"
                    ...
                    <!-- Modal -->
                    <div id="verModal-{{$item->id}}" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                        <div class="bg-white rounded-lg shadow-lg max-w-2xl w-full mx-4 max-h-96 overflow-y-auto">
                            ...
                            <div class="px-6 py-4">
                                <div class="grid grid-cols-1 gap-4">
                                    <div>
                                        <p><span class="font-bold">Descripción: </span>{{$item->descripcion ?? 'No tiene'}}</p>
                                    </div>
                                    <div>
