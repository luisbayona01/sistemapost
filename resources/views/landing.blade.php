    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition duration-300">
                ...
                <p class="text-gray-600">Sistema de punto de venta optimizado para cines y eventos con interfaz intuitiva y rápida.</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition duration-300">
                ...
                <p class="text-gray-600">Sistema completo de cajas con auditoría, apertura/cierre y control total de movimientos.</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition duration-300">
                ...
                <p class="text-gray-600">Integración segura con Stripe para procesar pagos con tarjeta en tiempo real.</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition duration-300">
                <div class="w-12 h-12 bg-indigo-100 rounded-lg flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 12H9m6 0H9m6 0a12 12 0 01-12 0M9 12a12 12 0 0112 0"></path>
                    </svg>
                </div>
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Multiempresa</h3>
                <p class="text-gray-600">Administra múltiples sucursales desde una sola plataforma con datos totalmente segregados.</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition duration-300">
                ...
                <p class="text-gray-600">Acceso a reportes detallados de ventas, inventario, cajas y métricas en tiempo real.</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition duration-300">
                ...
                <p class="text-gray-600">Roles y permisos granulares, auditoría completa y cifrado de datos sensibles.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-16 sm:py-24 bg-white">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="border-2 {{ $plan->nombre === 'Profesional' ? 'border-blue-600' : 'border-gray-200' }} rounded-lg p-8">
