...
class ProveedoreController extends Controller
{
    function __construct()
    {
        ...
        $this->middleware('permission:crear-proveedore', ['only' => ['create', 'store', 'quickStore']]);
    ...
    public function quickStore(Request $request)
    {
        $request->validate([
            ...
            'tipo' => 'required', // Se valida contra el enum o tipos esperados
        ...
        try {
            ...
            $proveedor = $persona->proveedore()->create([
